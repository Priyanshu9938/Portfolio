...
export default function MusicHero({
  ...
  useEffect(() => {
    ...
    // Attach to the component element, NOT window — this scopes the
    // scroll-lock so it only captures wheel/touch events inside the
    // component's bounds, letting the rest of the page scroll freely.
